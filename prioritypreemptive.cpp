...
PriorityPreemptive::PriorityPreemptive(QObject *parent, std::vector<Process> processes)
    ...
    })
{
    ...
    connect(schedulerTimer, &QTimer::timeout, this, &PriorityPreemptive::schedule);
...
void PriorityPreemptive::addNewProcess(Process *p)
{
