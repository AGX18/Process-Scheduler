...
SJFNonPreemptive::SJFNonPreemptive(QObject *parent, std::vector<Process> processes)
    ...
    })
{
    ...
    connect(schedulerTimer, &QTimer::timeout, this, &SJFNonPreemptive::schedule);
...
void SJFNonPreemptive::schedule() {
...
void SJFNonPreemptive::addNewProcess(Process *p)
{
